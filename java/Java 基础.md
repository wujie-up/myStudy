...
public class OuterClass {
    ...
    static class StaticInnerClass { 
        public StaticInnerClass {
            // age = 1;  // Non-static field 'y' cannot be referenced from a static context
            name = "staticInner";
        }
    }
...
在使用静态变量和方法时不用再指明 类名，从而简化代码，但可读性大大降低。

```java
import static com.xxx.OuterClass.*;
